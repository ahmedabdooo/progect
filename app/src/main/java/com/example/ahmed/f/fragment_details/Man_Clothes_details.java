...
public class Man_Clothes_details extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_man__clothes_details);
        ...
        fNotesDatabase = FirebaseDatabase.getInstance().getReference("ManClothes");
